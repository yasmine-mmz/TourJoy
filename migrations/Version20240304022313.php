 ...
 */
final class Version20240304022313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE country (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, region VARCHAR(255) NOT NULL, visa_required TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_5373C9665E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE guide (country_id INT DEFAULT NULL, CIN INT NOT NULL, image_name VARCHAR(255) DEFAULT NULL, firstname_g VARCHAR(255) NOT NULL, lastname_g VARCHAR(255) NOT NULL, emailaddress_g VARCHAR(255) NOT NULL, phonenumber_g VARCHAR(255) NOT NULL, gender_g VARCHAR(255) NOT NULL, language VARCHAR(255) NOT NULL, dob DATE NOT NULL, INDEX IDX_CA9EC735F92F3E70 (country_id), PRIMARY KEY(CIN)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE transport (id INT AUTO_INCREMENT NOT NULL, country_id INT DEFAULT NULL, type_t VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_66AB212E9ADB3123 (type_t), INDEX IDX_66AB212EF92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
